...
| **09. Multi-Agent SDR System** | [sdr_system.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%205/multi_agent_sdr/sdr_system.py) | Lead generation, automated qualification against ICP, and custom B2B cold emailing. | `google-genai` | High |
| **10. Policy Compliance Agent** | [compliance_agent.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%206/policy_compliance/compliance_agent.py) | Rule-based and semantic LLM audit checks of agent conversation logs for safety compliance. | `google-genai` | High |
| **11. Deep Research Agent Workflow** | [research_workflow.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%207/deep_research_agent/research_workflow.py) | Planning, drafting, self-reflection critique, and iterative refinement agent loop. | `google-genai` | High |
| **12. Multimodal Retrieval & VQA** | [multimodal_pipeline.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%208/image_retrieval_vqa/multimodal_pipeline.py) | Dynamic PIL image generator, multimodal image caption indexing, and visual QA pipeline. | `google-genai`, `pillow` | High |
| **13. Reasoning Benchmarking** | [benchmarking.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%209/reasoning_benchmarking/benchmarking.py) | Compare Zero-Shot, Few-Shot, CoT, and Self-Consistency prompting accuracy/latency. | `google-genai`, `matplotlib` | High |
| **14. Fine-Tuning Simulation** | [fine_tuning_experiment.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%2010/fine_tuning_simulation/fine_tuning_experiment.py) | Instruction data prep (JSONL formatting), training loss curve plotting, base vs tuned evaluation. | `google-genai`, `matplotlib` | High |
| **15. Model Optimization** | [optimization_experiment.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%2011/model_optimization/optimization_experiment.py) | Post-training weight quantization (FP32 to INT8) and student-teacher knowledge distillation. | `scikit-learn`, `matplotlib` | High |
| **16. Capstone Project** | [main.py](file:///c:/Users/D.Megha%20vardhan/OneDrive/Desktop/advanced_workflows/Experiment%2012/capstone_project/main.py) | End-to-end Enterprise Support System combining SQLite query tool, RAG, safety checker, and FastAPI dashboard. | `fastapi`, `google-genai` | High |
